...
export const TimeLineData = [
  { year: 2016, text: 'Started to study on web development', },
  { year: 2017, text: 'Learned Adobe Photoshop, Adobe Illustrator, Adobe XD', },
  { year: 2018, text: 'Started to learn core JavaScript', },
  { year: 2019, text: 'Learned ReactJS, Django, Started with my main project', },
  { year: 2020, text: 'Studied and learned Next JS, jQuery', },
  { year: 2021, text: 'Working with the projects', },
  { year: 2022, text: 'Started creating web applications and mobile applications', },
];
